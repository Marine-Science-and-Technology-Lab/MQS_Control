...
message(STATUS "xbee: 4 messages, 0 services")

set(MSG_I_FLAGS "-Ixbee:/home/lab/mqs/src/xbee/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/lab/mqs/src/xbee/msg/mqs_ctrl.msg" NAME_WE)
add_custom_target(_xbee_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "xbee" "/home/lab/mqs/src/xbee/msg/mqs_ctrl.msg" ""
)

get_filename_component(_filename "/home/lab/mqs/src/xbee/msg/script_ctrl.msg" NAME_WE)
add_custom_target(_xbee_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "xbee" "/home/lab/mqs/src/xbee/msg/script_ctrl.msg" ""
)

get_filename_component(_filename "/home/lab/mqs/src/xbee/msg/cmd_ctrl.msg" NAME_WE)
add_custom_target(_xbee_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "xbee" "/home/lab/mqs/src/xbee/msg/cmd_ctrl.msg" ""
)

get_filename_component(_filename "/home/lab/mqs/src/xbee/msg/auto_ctrl.msg" NAME_WE)
add_custom_target(_xbee_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "xbee" "/home/lab/mqs/src/xbee/msg/auto_ctrl.msg" ""
)
...
### Generating Module File
_generate_module_eus(xbee
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/xbee
  "${ALL_GEN_OUTPUT_FILES_eus}"
)

add_custom_target(xbee_generate_messages_eus
...
# target for backward compatibility
add_custom_target(xbee_geneus)
add_dependencies(xbee_geneus xbee_generate_messages_eus)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS xbee_generate_messages_eus)
...
### Generating Module File
_generate_module_nodejs(xbee
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/xbee
  "${ALL_GEN_OUTPUT_FILES_nodejs}"
)

add_custom_target(xbee_generate_messages_nodejs
...
# target for backward compatibility
add_custom_target(xbee_gennodejs)
add_dependencies(xbee_gennodejs xbee_generate_messages_nodejs)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS xbee_generate_messages_nodejs)
...
if(geneus_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/xbee)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/xbee
    DESTINATION ${geneus_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_eus)
  add_dependencies(xbee_generate_messages_eus std_msgs_generate_messages_eus)
endif()
...
if(gennodejs_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/xbee)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/xbee
    DESTINATION ${gennodejs_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_nodejs)
  add_dependencies(xbee_generate_messages_nodejs std_msgs_generate_messages_nodejs)
endif()

if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/xbee)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/xbee\")")
  # install generated code
  install(
